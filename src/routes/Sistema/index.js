...
const Sistema = ({match}) => {
    ...
    return(
        <div className="gx-main-content-wrapper" >
            ...
            {/* Esta web utiliza cookies propias y de terceros para fines analíticos y para mostrarte publicidad personalizada en base a un perfil elaborado a partir de tus hábitos de navegación (por ejemplo, páginas visitadas). Clica AQUÍ para más información. Puedes aceptar todas las cookies pulsando el botón “Permitir todas las cookies”, rechazarlas pulsando “Solo usar las cookies necesarias” o configurarlas seleccionándolas y pulsando a continuación el botón “Permitir la selección<br/> */}
